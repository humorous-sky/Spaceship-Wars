...
public class Ability {
	...
	public static final String[] descriptions = {"Makes you instantly move a distance in your direction (you must move while activating). Recharges every 15 seconds. ",
